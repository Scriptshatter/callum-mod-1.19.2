...
public class ItemRegister {
    ...
    public static final Item BONE_PIN = register_item("bone_pin", new Upgrade_item(new FabricItemSettings().group(CALLUM), 0xffd4a3, Callum.identifier("callum_pilot"), null, WEIRD_SKIN));
    //More pins more defence
    public static final Item LUMBERJACK_PIN = register_item("lumberjack_pin", new Upgrade_item(new FabricItemSettings().group(CALLUM), 0xec273f, Callum.identifier("callum_pilot"), "lumberjack", WEIRD_SKIN));
    ...
    public static final Item MOON_PIN = register_item("moon_pin", new Upgrade_item(new FabricItemSettings().group(CALLUM), 0xd68fb8, Callum.identifier("callum_pilot"), "time", WEIRD_SKIN));
